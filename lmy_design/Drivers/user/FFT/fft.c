...
//    for (i = 0; i < FFT_Len; i++)
//    {
//        FFT_Inputbuf[i] = 1 + cos(2 * PI * 50 * i / FFT_Len);
//////        FFT_Inputbuf[i] = 0.1 + 0.5 * arm_cos_f32(2 * PI * 50 / FFT_Len + PI / 3) + 0.2 * cos(2 * PI * 20 * i / FFT_Len + PI / 6) + 0.1 * cos(2 * PI * 5 * i / FFT_Len + PI / 6);
