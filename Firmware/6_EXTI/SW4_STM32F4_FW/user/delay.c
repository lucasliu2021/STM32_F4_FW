...
//ALIENTEK STM32F407开发板 针对适应STM32F401做了相应改动
...
void delay_init(uint8_t SYSCLK)
{
	...
	uint32_t reload;
#endif
	//【STM32F401主频为84Mhz，8分频后10.5次计数为1us，只能记录21次计数后为2us，如果采用10.5次，则延时误差5%】
	SYSCLK *= 2;
 	HAL_SYSTICK_CLKSourceConfig(SYSTICK_CLKSOURCE_HCLK_DIV8);     
	//【针对STM32F401每采集21次计数后为2us，fac_us=21】
...
#else
	//【针对STM32F401每采集21*1000次计数后为2ms，fac_ms=21*1000】
